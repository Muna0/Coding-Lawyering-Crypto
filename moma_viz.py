...
print("test")
con = psycopg2.connect("dbname=week4 user=postgres host=localhost port=5435")
print("test2")
...
def task2():
    ...
    query = '''
            SELECT 
            DISTINCT classification AS Classification, COUNT(classification) as Count
            FROM moma_works
...
def task3():
    ...
    query = '''
            SELECT
            DISTINCT info ->> 'nationality' AS Nationality, COUNT(*) as Count
            FROM moma_artists
